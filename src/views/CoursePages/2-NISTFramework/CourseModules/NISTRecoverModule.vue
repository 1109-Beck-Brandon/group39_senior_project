  ...
  <v-container fluid class="main-container">
    ...
    <v-row justify="center" align="center">
      <v-col cols="12" md="8" class="text-center">
        <h1 class="header-title">NIST CSF 2.0: Recover Function</h1>
        
        <!-- Interactive Image Map -->
        <div class="image-map-container">
          <img :src="headerImage" alt="NIST Recover Function" class="header-image" usemap="#nist-map" />
    ...
    <v-row justify="center" align="center">
      <v-col cols="12" md="8" class="text-center">
        <v-card elevation="3" class="intro-card pa-4 mb-6">
          <h2 class="section-title">Understanding the Recover Function</h2>
          <p class="section-description">
            The "Recover" function is a core component of the NIST Cybersecurity Framework 2.0. 
            This function focuses on recovering assets and services that were affected during
            a security incident and restoring normal operations. 
          </p>
        </v-card>
      </v-col>
    </v-row>
    ...
    <v-row justify="center" align="center">
      <v-col cols="12" md="9">
        <h2 class="section-title text-center">Key Recover Categories</h2>
        ...
        >
          <v-carousel-item v-for="(category, index) in recoverCategories" :key="index">
        ...
        <v-card class="mt-4 mb-6" elevation="2">
          <v-card-text class="pa-2">
            <div class="progress-text d-flex justify-space-between mb-1">
              <span>{{ recoverCategories[currentCategory].title }}</span>
              <span>{{ currentCategory + 1 }} of {{ recoverCategories.length }}</span>
            </div>
            <v-progress-linear
              :value="((currentCategory + 1) / recoverCategories.length) * 100"
              height="12"
              color="primary"
              rounded
              striped
...
export default {
  ...
  data() {
    return {
      ...
      recoverCategories: [
        {
          ...
          description: "Restoration activities begin in order to ensure the operational availability of the systems and services that were affected by the security incident. This includes selecting and prioritizing recovery actions, verifying the integrity of backups or other restoration tools before using them for restoration, and meeting certain recovery criteria before declaring the end of the recovery process.",
          outcomes: "Restored Operations, Minimized Downtime"
        },
        {
          title: "Incident Recovery Communication (RC.CO)",
          description: "Restoration activities are communicated to internal and external parties. The general public is also informed about the incident recovery using approved methods and messaging.",
          outcomes: "Full Transparency, Maintain Stakeholder Trust"
        }
      ],
      ...
      implementationStrategies: [
        {
          ...
          description: "Establish and regularly test backup and restore procedures to ensure data integrity and availability.",
          icon: "mdi-database-refresh"
        },
        {
          title: "Recovery Prioritization",
          description: "Prioritize recovery efforts based on the criticality of systems and data.",
          icon: "mdi-format-list-bulleted"
        },
        {
          title: "Post-Incident Recovery Review",
          description: "Conduct a review after recovery to identify lessons learned and improve future response efforts.",
          icon: "mdi-chart-bar"
        },
        {
          title: "Recovery Communication",
          description: "Ensure clear communication with stakeholders during the recovery process to maintain trust / transparency.",
      ...
      quizQuestions: [
        {
          text: "It is not necessary to check the integrity of backups or other restoration tools before using them for restoration.",
          type: "multiple-choice",
          options: ["True", "False"],
          answer: "False",
        },
        {
          text: "Which of the following is NOT a key outcome of the Recover function?",
          type: "multiple-choice",
          options: ["Restored Operations", "Minimal Downtime", "No Transparency", "Maintain Stakeholder Trust"],
          answer: "No Transparency",
        },
        {
          text: "Recovery efforts should be prioritized based on the criticality of systems and data.",
          type: "multiple-choice",
          options: ["True", "False"],
          answer: "True",
        }
