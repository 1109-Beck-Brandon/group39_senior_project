<template>
    <v-container fluid>
      <h1 class="course-title">Introduction to Cybsersecurity</h1>
      <v-row>
        <!-- Course Description Section with Background Box -->
        <v-col cols="12" md="6">
          <div class="description-box">
            <p class="course-description">This is a detailed description of Introduction to Cybsersecurity. Here, you can add any relevant information.</p>
          </div>
        </v-col>
