...
export default {
  ...
  methods: {
    ...
    incrementProgress() {
      const increment = Math.floor(100 / this.questions.length);
      this.progressPercentage = Math.min(this.progressPercentage + increment, 100);
    },
    generateUserId() {
    ...
    finishOnboarding() {
      const onboardingData = {
        ...
        content_type: this.answers.contentType || "",
        referral: this.answers.referral || "",
        user_id: this.autoGeneratedUserId,
      };
      ...
      if (user && user.user_id) {
        ...
        console.error("No valid user found for onboarding update.");
      }
    },
