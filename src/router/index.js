...
import QuizLab from '../views/CoursePages/1-IntroToCybersecurity/CourseModules/QuizLab.vue';
...
const routes = [
  ...
  { path: '/moduleQuiz', name: 'QuizLab', component: QuizLab },
  ...
  { path: "/course/intro-to-cybersecurity/OSI_module", component: Course1LabModule},
]
