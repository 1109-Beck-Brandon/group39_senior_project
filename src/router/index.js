...
import CourseIntroToTheory from '../views/CoursePages/1-IntroToCybersecurity/IntroductionToTheory.vue'
...
const routes = [
  ...
  { path: "/course/intro-to-theory", name: "IntroToTheory", component: CourseIntroToTheory },
